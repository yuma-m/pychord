...
from .quality import QualityManager, Quality, _augment, _diminish, _scale_notes
from .utils import (
    transpose_note,
    display_appended,
    display_on,
...
class Chord:
    ...
    def from_note_index(
        ...
        root = _scale_notes(scale_root, scale_mode)[note - 1]
        if chromatic != 0:
            alter = _augment if chromatic > 0 else _diminish
